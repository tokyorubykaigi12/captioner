// clang -framework Foundation -framework CoreAudio inputdevicelist.m -o inputdevicelist
...
int main(int argc, const char * argv[]) {
     @autoreleasepool {
        ...
        if (inputDevices) {
            NSArray *inputDevicesArray = (__bridge NSArray *)inputDevices;
            NSLog(@"Input Devices: %@", inputDevicesArray);
            CFRelease(inputDevices);
        } else {
            NSLog(@"Failed to get input devices");
        }
    }
    return 0;
}
